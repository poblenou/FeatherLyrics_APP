...
public class MusicListAdapter extends SimpleCursorAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView titulo = (TextView) convertView.findViewById(R.id.music_list_adapter_songName);
        TextView grupo = (TextView) convertView.findViewById(R.id.music_list_adapter_artistName);

        titulo.setText(peliculas.getString(peliculas.getColumnIndex(MusicColumns.TITLE)));
        grupo.setText(peliculas.getString(peliculas.getColumnIndex(MusicColumns.BAND)));
